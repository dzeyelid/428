...
<div class="restaurants view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($restaurant->credit_card_id) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Halal') ?></th>
            <td><?= $restaurant->halal ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Vegan') ?></th>
            <td><?= $restaurant->vegan ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Gluten Free') ?></th>
            <td><?= $restaurant->gluten_free ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
</div>
