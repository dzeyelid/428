...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Search Restaurant'), ['action' => 'search']) ?></li>
    </ul>
</nav>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('halal') ?></th>
                <th scope="col"><?= $this->Paginator->sort('vegan') ?></th>
                <th scope="col"><?= $this->Paginator->sort('gluten_free') ?></th>
